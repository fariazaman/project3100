...
<html>
	<head>
		<title>Fu-Wang Dominuous Resort</title>
	...
	<p><h3>Welcome to the page of Fu-Wang Dominuous Resort</h3></p>
	...
	<th colspan="4">AVAILABLE ROOM INFORMATION</th>
		...
		// Check connection
			...
			$sql = "SELECT Date_to_be_booked,Catagory,Total_room,Available from room_info_fuwang";
	...
	<th colspan="4">BOOKING INFORMATION</th>
		...
		// Check connection
			...
			$sql = "SELECT Date_to_be_booked,ID,Catagory,No_of_Rooms from booking_info_fuwang";
			$result = $conn->query($sql);
	...
	<th colspan="5">CUSTOMER'S INFORMATION</th>
		...
		// Check connection
			...
			$sql = "SELECT ID,Full_Name,Contact_no,Gender,Address from customers_info_fuwang";
			$result = $conn->query($sql);
